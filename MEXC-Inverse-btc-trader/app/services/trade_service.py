...
# Removed: from app.services.backfill_service import maybe_backfill_candles
# Removed Bybit HTTP import; using MexcClient instead.
...
# Use MexcClient instead of Bybit HTTP client.
...
def enhanced_get_market_regime(df, adx_period=14, base_threshold=25):
    ...
    try:
        ...
        # Adaptive threshold: lower the ADX threshold based on volatility.
...
class TradeService:
    ...
    async def run_trading_logic(self):
        # Wait until both the trend and signal models are ready.

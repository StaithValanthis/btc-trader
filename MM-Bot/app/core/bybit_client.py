...
class BybitMarketData:
    ...
    async def _reconnect(self):
        ...
        if self.reconnect_attempts < self.max_reconnect_attempts:
            ...
            logger.warning("Reconnecting attempt",
        ...
        while self.running and self.ws:
            async with self.recv_lock:
                try:
                    ...
                    # Connection was closed by the remote or locally
                    # If it's a normal closure (1000), handle more gracefully
                    if e.code == 1000:
                        logger.warning("WebSocket closed normally (1000). Reconnecting gracefully...")
